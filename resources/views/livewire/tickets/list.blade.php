                ...
                @forelse($tickets as $ticket)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ $ticket->customer->document }}</div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full 
                                {{ $ticket->sla_status_color === 'green' ? 'bg-green-100 text-green-800' : 
                                   ($ticket->sla_status_color === 'yellow' ? 'bg-yellow-100 text-yellow-800' : 
                                   ($ticket->sla_status_color === 'red' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800')) }}">
